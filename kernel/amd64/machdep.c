...
setup_cpu_gdt(cpu_t *cpu)
{
	...
	gdt.tss.length = 0x68;
	gdt.tss.base_low = (uintptr_t)cpu->arch_cpu.tss;
	gdt.tss.base_mid = (uintptr_t)cpu->arch_cpu.tss >> 16;
	gdt.tss.access = 0x89;
	gdt.tss.flags = 0x0;
	gdt.tss.base_high = (uintptr_t)cpu->arch_cpu.tss >> 24;
	gdt.tss.base_upper = (uintptr_t)cpu->arch_cpu.tss >> 32;
