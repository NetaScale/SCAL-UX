...
int sys_open(struct proc *proc, const char *path, int mode);
int sys_close(struct proc *proc, int fd, uintptr_t *errp);
int sys_read(struct proc *proc, int fd, void *buf, size_t nbyte);
int sys_write(struct proc *proc, int fd, void *buf, size_t nbyte);
int sys_seek(struct proc *proc, int fd, off_t offset, int whence);
int sys_pselect(struct proc *proc, int nfds, fd_set *readfds, fd_set *writefds,
