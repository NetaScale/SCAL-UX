...
mkdir build-mlibc1
cd build-mlibc1
meson --cross-file=../scalux-amd64.ini --prefix=user -Dheaders_only=true
ninja
...
mkdir ../bld-mlibc2
cd ../bld-mlibc2
meson --cross-file ../../scalux-gcc-x64.ini  --prefix=/usr --libdir=lib -Dmlibc_no_headers=true ../../mlibc
ninja
ninja install
